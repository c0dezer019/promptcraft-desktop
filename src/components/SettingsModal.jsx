...
export const SettingsModal = ({ isOpen, onClose }) => {
    ...
    // Generation settings (without Midjourney)
            ...
            <div className="bg-white dark:bg-gray-900 w-full max-w-2xl rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 overflow-y-auto">
                    {activeTab === 'enhancement' ? (
                        <div className="space-y-5">
                            <div className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg border border-indigo-100 dark:border-indigo-800">
                                <p className="text-xs text-indigo-700 dark:text-indigo-300 leading-relaxed flex items-start gap-2">
                                    ...
                                    />
                                    <span>
                                        Configure your preferred AI engine to
                                        power features like Magic Enhance and
                                        Auto-Negative. API keys are stored
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            value={
                                                enhancementKeys[provider] || ''
                                            }
                                            onChange={e =>
                                                updateEnhancementKey(
                                                    e.target.value
                                                )
                                            }
                                            placeholder={
                                ...
                                {provider === 'openai' && (
                                    <div>
                                        ...
                                        <p className="text-[10px] text-gray-400 mt-1">
                                            Use for DeepSeek, Mistral, Ollama,
                                            etc.
                                        </p>
                                    </div>
                                )}
                        ...
                        <div><LocalToolSetup isEmbedded /></div>
                    ) : (
                        /* Generation Tab */
                        <div className="space-y-5">
                            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg border border-purple-100 dark:border-purple-800">
                                <p className="text-xs text-purple-700 dark:text-purple-300 leading-relaxed flex items-start gap-2">
                                    ...
                                    <span>
                                        ...
                                        providers. Enable providers to use
                                        direct API generation for images and
                                        videos. Keys are stored securely.
                                    </span>
                                </p>
                            </div>
                                            ...
                                            <div
                                                ...
                                                <div className="flex items-start justify-between mb-3">
                                                    <div className="flex items-center gap-3">
                                                        <div
                                                            className={`p-2 rounded-lg ${config.enabled ? 'bg-purple-100 dark:bg-purple-900/30' : 'bg-gray-100 dark:bg-gray-800'}`}>
                                                            <Icon
                                                                size={20}
                                                                className={
                                                                    config.enabled
